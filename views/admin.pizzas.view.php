                ...
                <div class="table-responsive">
                    <form action="" method="">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <td style="width: 10rem;"><img class="pizza-img" src="./assets/margaritha.webp" alt="margaritha.webp" srcset=""></td>
                                <td>Pizza Margaritha</td>
                                <td><input class="form-control form-control-sm w-100" type="number" placeholder="Rozmiar"><span> cm</span></td>
                                <td>
                                    <ul>
                                        <li>Mozarella</li>
