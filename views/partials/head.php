<head>
    ...
    <!-- <link rel="stylesheet" href="./styles/animations.css" media="all"> -->
    <link rel="stylesheet" href="./styles/themes.css" media="all">
    ...
    <script defer async src="./bootstrap/dist/js/bootstrap.min.js"></script>
