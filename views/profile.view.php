    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex w-100 position-relative">
                ...
                <?= $user->is_admin == 1 ? '<a href="#" type="button" class="btn btn-primary align-middle position-absolute end-0 top-0"><i class="bi bi-database-fill"></i> Panel zarządzania</a></div>' : '' ?>
            </div>
